...
describe('<CodeInput />', function () {
  ...
  it('should have label rendered if label is sent as param', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_["default"], {
      label: "label-test"
    }));
    expect(component.find(_styled.StyledLabel).exists()).toBe(true);
  });
  it('should not have label rendered when label is emtpy', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_["default"], null));
    expect(component.find(_styled.StyledLabel).exists()).toBe(false);
  });
