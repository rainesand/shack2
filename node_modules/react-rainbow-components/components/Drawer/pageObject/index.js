...
function getPointOutsideDrawer(drawerPosition, drawerSize) {
  ...
  var y = drawerPosition.y > 0 ? drawerPosition.y - 2 : drawerSize.height + 2;
  return {
    x: x,
    y: y
  };
...
function () {
  ...
  (0, _createClass2["default"])(PageDrawer, [{
    ...
    value: function clickBackDrop() {
      ...
      var _getPointOutsideDrawe = getPointOutsideDrawer($(this.rootElement).$('section[role="dialog"]').getLocation(), $(this.rootElement).$('section[role="dialog"]').getSize()),
