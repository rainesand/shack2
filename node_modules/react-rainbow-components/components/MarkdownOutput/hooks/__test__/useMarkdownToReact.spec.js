...
describe('useMarkdownToReact', function () {
  ...
  it('should return valid html for code', function () {
    var values = ['```js\ndoSomething();\n```', '`doSomenthing`'];
    var patterns = [/<pre[^>]*><code class="hljs language-js[^>]*>([^<]*)<\/code><\/pre>/, /<code\s[^>]*>doSomenthing<\/code>/];
    values.forEach(function (value, index) {
  ...
  it('should return valid html for links', function () {
    ...
    expect(_server["default"].renderToString(result.current)).toMatch(/<a href="http:\/\/www.example.com\/" title="A link">Link<\/a>/i);
  });
});