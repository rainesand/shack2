...
describe('findCountryByIsoCode', function () {
  it('should return an array with  United States country', function () {
    ...
    var allCountries = [us].concat(countries);
    queries.forEach(function (query) {
      return expect((0, _filterCountries["default"])(query, allCountries, us)).toEqual([us]);
    });
  });
  it('should return an array with 4 countries', function () {
    ...
    var allCountries = [us].concat(countries);
    queries.forEach(function (query) {
      return expect((0, _filterCountries["default"])(query, allCountries, us)).toEqual(allCountries);
    });
  });
  it('should return an empty array', function () {
    ...
    var allCountries = [us].concat(countries);
    queries.forEach(function (query) {
      return expect((0, _filterCountries["default"])(query, allCountries, us)).toEqual([]);
    });
  });
});