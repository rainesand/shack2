...
var _scrollShadow = _interopRequireDefault(require("./styled/scrollShadow"));
  ...
  (0, _createClass2["default"])(Header, [{
    ...
    value: function render() {
      var _this$props4 = this.props,
          ...
          hasScroll = _this$props4.hasScroll,
          variant = _this$props4.variant;
      var headerStyles = {
        width: computedWidth
      };
      var isResizable = this.isResizable();
      var isListView = variant === 'listview';
      ...
      return _react["default"].createElement(_th["default"], {
        ...
        isTrue: !isListView
      }, _react["default"].createElement(_scrollShadow["default"], {
        hasScroll: hasScroll
      }))));
    }
  }]);
