...
describe('<InputBase/>', function () {
  ...
  it('should set the labelAlignment prop passed in the StyledLabelContainer element', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_["default"], {
      labelAlignment: "left"
    }));
    expect(component.find(_labelContainer["default"]).prop('labelAlignment')).toBe('left');
  });
