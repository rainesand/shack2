...
function () {
  ...
  (0, _createClass2["default"])(PageInternalDropdown, [{
    ...
    value: function hoverScrollUpArrow() {
      return $(this.rootElement).$('[data-id="internal-dropdown-arrow-up"]').moveTo();
    }
    /**
    ...
    value: function hoverScrollDownArrow() {
      return $(this.rootElement).$('[data-id="internal-dropdown-arrow-down"]').moveTo();
    }
    /**
